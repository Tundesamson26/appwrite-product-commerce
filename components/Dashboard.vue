      ...
      <div class="u-flex u-main-center u-main-space-between u-cross-center">
        ...
        <div class="u-text-center">
          ...
          <div v-if="showModal" class="modal-overlay" id="dialog">
            <div class="modal">
              <form class="modal-form" method="dialog" @submit.prevent="createProduct">
                ...
                <ul class="form-list">
                  ...
                  <li class="form-item">
                    ...
                    <div class="input-text-wrapper">
                      <input type="text" class="input-text" placeholder="Image link" v-model="productImage" />
                    </div>
                  </li>
                  <li class="form-item">
                    <label class="label">Description</label>
                    <div class="input-text-wrapper">
                      <input type="text" class="input-text" placeholder="Product Description" v-model="productDesc" />
                    </div>
                  </li>
                  <div class="u-flex u-cross-center">
                    <li class="form-item">
                      ...
                      <div class="input-text-wrapper">
                        <input type="text" name="productPrice" placeholder="Price" v-model="productPrice" />
                      </div>
                    </li>
                    <li class="form-item">
                      ...
                      <div class="input-text-wrapper">
                        <div class="select" style="width: 122%">
                          <select name="pets" id="pet-select" v-model="productSize">
